...
- Minor structural and documentation changes
...
- Automatic Deep copy
- Code Documentation
- `parseInto()` on dynamic JSON
- `free()` for deep copy structures

### Changed

- Working demos on `main.zig`

### Fixed

- Memory bugs on parsed structure
